...
/* Boton varios agentes whatsapp */
var mainDiv = document.getElementById('main-button');
mainDiv.addEventListener('click', function(){
  this.children.item(0).classList.toggle('fa-times');
  this.classList.remove('closed');
  this.classList.toggle('open');
  var icono = this.children.item(0).innerHTML;
  if(this.children.item(0).classList.contains('fa-comments')){
    this.children.item(0).innerHTML = icono.replace('<i class="fas fa-times"></i>', '');
  } else {
    this.children.item(0).innerHTML = icono;
  }
});
	// using jQuery
	...
	/* Fin Boton varios agentes whatsapp */
}());